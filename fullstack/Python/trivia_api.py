...
class Trivia:
    ...
    def get_question(self, data) -> dict:
        ...
        try:  # Try to get the question from the results.
            ...
            print(
                f"{Fore.RED}>>>No questions found. Using default URL.<<<{Style.RESET_ALL}"
...
if __name__ == "__main__":
    ...
    data = trivia.get_data_from_settings(
        settings["difficulty"], settings["type"], settings["category"]
    )
    ...
    while play_again:  # Loop until the user says no.
        ...
        play_again = None # Set play_again to None as default.
        while (
            play_again == None
            ...
            match play_again.lower().split():  # Split the answer into a list for structural pattern matching.
